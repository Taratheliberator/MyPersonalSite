...
public class BlogController {
    ...
    public String blogSave(@RequestParam(required = false) Long id, @RequestParam String title, @RequestParam String content) {
        Post post = new Post(id, title, content); // id может быть null для новых постов
